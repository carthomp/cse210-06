...
from game.scripting.draw_ship import DrawShip
...
class SceneManager:
    ...
    def _add_output_script(self, script):
        ...
        script.add_action(OUTPUT, self.DRAW_BULLETS)
        script.add_action(OUTPUT, self.DRAW_ENEMY_SHIP)
        script.add_action(OUTPUT, self.DRAW_SHIP)
